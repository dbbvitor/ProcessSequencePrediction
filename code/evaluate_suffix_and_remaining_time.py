...
model_name = 'model_14-1.52.h5'
# load model, set this to the model generated by train.py
model = load_model(str((Path.cwd()/'code'/'output_files'/'models'/'{}'.format(model_name)).resolve()))
...
# make predictions
with open(str((Path.cwd()/'code'/'output_files'/'results'/'suffix_and_remaining_time_''{}'.format(eventlog)).resolve()), 'w') as csvfile:
